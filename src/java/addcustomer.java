...
Connection con; PreparedStatement ps;PreparedStatement ps1;PreparedStatement ps2;
 ...
 @Override
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String qr="insert into "+ac+"customer values(?,?,?,?,?,?,?)";
        ...
        try{
        String sr="select * from "+ac+"customer where contactnumber=?";
        ps1=con.prepareStatement(sr);
            ps1.setString(1,contactnumber);
            ResultSet rs=ps1.executeQuery();
            boolean b=rs.next();
           String em="select * from "+ac+"customer where email=?";
        ...
        ps.executeUpdate();
        response.sendRedirect("customersavesuccessfully.jsp");    
                     }
           else{
