...
public class adminsavechangesupdateinfo extends HttpServlet {
   ...
   @Override
    public void init(){
        try{
        String qr="update admininfo set messname=?, username=?, email=?, address=?,password=? where contactnumber=?";
