...
<html lang="en">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      <li class="nav-item active">
       ...
       <li class="nav-item">
        ...
        <div class="title" style="top: 900%">
          <h1>MESS MANAGEMENT SYSTEM</h1>
            <p><a class="btn btn-primary btn-lg" href="#Learn more »" role="button">Learn more »</a></p>
    ...
    <div class="container" id="#Learn more »">
      ...
      <p>My ItEM Pvt Ltd. is an Indian electronic commerce company based in INDORE, India. Founded by sourabh chourasiya  in 2019, the company initially focused on book sales, before expanding into other product categories such as consumer electronics, fashion, and lifestyle products.
...
In August 2018, U.S.-based retail chain Walmart acquired a 77% controlling stake in Flipkart for US$16 billion, valuing it at $22 billion.</p>
       ...
       <nav class="navbar navbar-expand-lg navbar-dark bg-dark" style="  height: 6rem; ">
